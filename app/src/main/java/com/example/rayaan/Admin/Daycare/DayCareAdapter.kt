package com.example.rayaan.Admin.Daycare
...
class DayCareAdapter(private val list: ArrayList<DayCare>, private val context: Activity, private val a: Activity)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.admin_daycare_recycler_row, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.working.setOnClickListener(View.OnClickListener {
