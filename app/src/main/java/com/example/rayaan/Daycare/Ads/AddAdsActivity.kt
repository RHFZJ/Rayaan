    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        add.setOnClickListener(View.OnClickListener {
            if(title.text.toString().isEmpty()){
                ...
                uploadImage(a)
                val uniqueKey = mDatabase!!.child("Ads").push().key
                mDatabase!!.child("Ads").child(uniqueKey.toString())
        ...
        if (filePath != null) {
            ...
            ref!!.putFile(filePath)
                .addOnSuccessListener {
                    Toast.makeText(this@AddAdsActivity, "تم اضافة الاعلان", Toast.LENGTH_SHORT).show()
                    finish()
